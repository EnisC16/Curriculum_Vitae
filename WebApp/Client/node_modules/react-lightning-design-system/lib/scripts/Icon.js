  ...
  (0, _createClass2["default"])(Icon, [{
    ...
    value: function renderSVG(_ref) {
      ...
      var _ref$className = _ref.className,
          ...
          props = (0, _objectWithoutProperties2["default"])(_ref, ["className", "category", "size", "icon", "align", "fillColor", "container", "textColor", "style", "assetRoot"]);
      ...
      }, (0, _defineProperty2["default"])(_classnames, "slds-icon_".concat(size), /^(x-small|small|medium|large)$/.test(size)), (0, _defineProperty2["default"])(_classnames, "slds-icon-text-".concat(textColor), /^(default|warning|error)$/.test(textColor || '') && !iconColor), (0, _defineProperty2["default"])(_classnames, "slds-icon-".concat(iconColor), !container && iconColor), (0, _defineProperty2["default"])(_classnames, 'slds-m-left_x-small', align === 'right'), (0, _defineProperty2["default"])(_classnames, 'slds-m-right_x-small', align === 'left'), _classnames), className); // icon and category prop should not include chars other than alphanumerics, underscore, and hyphen
      ...
      return /*#__PURE__*/_react["default"].createElement("svg", (0, _extends2["default"])({
        ...
        style: style
      }, props), /*#__PURE__*/_react["default"].createElement("use", {
        xlinkHref: iconUrl
      }));
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          props = (0, _objectWithoutProperties2["default"])(_this$props2, ["container", "size"]);
      ...
      if (container) {
        ...
        var iconColor = this.getIconColor(fillColor, category, icon);
        var ccontainerClassName = (0, _classnames2["default"])(containerClassName, 'slds-icon_container', container === 'circle' ? 'slds-icon_container_circle' : null, iconColor ? "slds-icon-".concat(iconColor) : null);
