...
var DatepickerDropdown = /*#__PURE__*/function (_Component) {
  _inherits(DatepickerDropdown, _Component);
...
var DatepickerDropdownPortal = autoAlign({
 ...
 *
 */
export var DateInput = /*#__PURE__*/function (_Component2) {
  ...
  function DateInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_this3), "datepicker", null);
    ...
    _this3.onDateIconClick = _this3.onDateIconClick.bind(_assertThisInitialized(_this3));
    _this3.onInputKeyDown = _this3.onInputKeyDown.bind(_assertThisInitialized(_this3));
    _this3.onInputChange = _this3.onInputChange.bind(_assertThisInitialized(_this3));
    _this3.onInputBlur = _this3.onInputBlur.bind(_assertThisInitialized(_this3));
    _this3.onDatepickerSelect = _this3.onDatepickerSelect.bind(_assertThisInitialized(_this3));
    _this3.onDatepickerBlur = _this3.onDatepickerBlur.bind(_assertThisInitialized(_this3));
    _this3.onDatepickerClose = _this3.onDatepickerClose.bind(_assertThisInitialized(_this3));
    registerStyle('dateinput', [['.slds-has-error .slds-datepicker .slds-select', '{ border: 1px solid #d8dde6; box-shadow: none; }']]);
    return _this3;
  }
  ...
  _createClass(DateInput, [{
    ...
    value: function onDatepickerSelect(dvalue) {
      ...
      var value = moment(dvalue).format(this.getValueFormat());
      this.setState({
        value: value,
        inputValue: null
      });
    ...
    value: function setValueFromInput(inputValue) {
      ...
      if (!inputValue) {
        ...
        var mvalue = moment(inputValue, this.getInputValueFormat());
    ...
    value: function isFocusedInComponent() {
      ...
      return isElInChildren(this.node, targetEl) || isElInChildren(this.datepicker, targetEl);
    }
  }, {
    key: "showDatepicker",
    value: function showDatepicker() {
      ...
      if (this.state.inputValue != null) {
        var mvalue = moment(this.state.inputValue, this.getInputValueFormat());
    ...
    value: function renderInput(_ref) {
      ...
      var inputValue = _ref.inputValue,
          props = _objectWithoutProperties(_ref, ["inputValue"]);
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          props = _objectWithoutProperties(_this$props2, ["className", "totalCols", "cols", "label", "required", "error", "value", "menuAlign", "minDate", "maxDate", "opened", "extensionRenderer", "dateFormat", "defaultValue", "defaultOpened", "includeTime", "onComplete", "onValueChange"]);

      var dateValue = typeof value !== 'undefined' ? value : this.state.value;
      var mvalue = moment(dateValue || undefined, this.getValueFormat());
      ...
      return /*#__PURE__*/React.createElement(FormElement, _extends({
        ...
        className: classnames(className, 'slds-dropdown-trigger')
      }, this.renderInput(_objectSpread({
        id: id,
        inputValue: inputValue
      }, props)), isOpened ? /*#__PURE__*/React.createElement(DatepickerDropdownPortal, {
...
_defineProperty(DateInput, "isFormElement", true);
